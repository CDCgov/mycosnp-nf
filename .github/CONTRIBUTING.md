# `mycosnp`: Contributing Guidelines

Hi there!
Many thanks for taking an interest in improving mycosnp.

We try to manage the required tasks for mycosnp using GitHub issues, you probably came to this page when creating one.
...
To make the `mycosnp` code and processing logic more understandable for new contributors and to ensure quality, we semi-standardise the way the code and other contributions are written.
