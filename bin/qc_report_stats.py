...
df1 = pd.read_csv(args.base_content_before_trim,
...
df2 = pd.read_csv(args.base_content_after_trim,
                 delim_whitespace=True, header=None, index_col=None)
...
f1 = pd.read_csv(args.qual_scores_before_trim,
...
f2 = pd.read_csv(args.qual_scores_after_trim,
                delim_whitespace=True, index_col=None)
...
output_string = ""
output_list = [sample_name, reads_before_trim , str(GC_content_before), str(phred_avg_before), reads_after_trim, paired_reads_after_trim, unpaired_reads_after_trim, str(GC_content_after), str(phred_avg_after), str(coverage)]
